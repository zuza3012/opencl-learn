...
int main(int argc, char* argv[]){
    ...
    try{
        ...
        cl::Buffer bufferOut(context, CL_MEM_WRITE_ONLY, datasize);
        ...
        std::string file_rel_path = "/../ndRange.cl";
       ...
       //cl::Program::Sources source(1, std::make_pair(kernelSource, strlen(kernelSource)));
        ...
        cl::Kernel kernel(program, "getFancyArray");
        ...
        queue.enqueueReadBuffer(bufferOut, CL_TRUE, 0, datasize, output);
